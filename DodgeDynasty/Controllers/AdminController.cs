...
namespace DodgeDynasty.Controllers
{
	public class AdminController : BaseController
	{
		...
		public ActionResult PlayerAdjustments(string page)
		{
			...
			//var model = new PlayerAdjustmentsModel();
			//model.AddedPlayers = new List<Models.Types.AdjustedPlayer>();
			//model.AddedPlayers.Add(new Models.Types.AdjustedPlayer
			//{
			//	PlayerId = 2678,
			//	TruePlayerId = 2678,
			//	PlayerName = "Ganja Gordon",
			//	Position = "WR",
			//	NFLTeamDisplay = "Atlanta Falcons",
			//	Action = "Admin Add Player",
			//	UserFullName = "George Hayek",
			//	DraftsRanksText = "---",
			...
			//	PlayerId = 8723,
			//	TruePlayerId = 239,
			//	PlayerName = "Bismo Funyons",
			//	Position = "RB",
			//	NFLTeamDisplay = "Tennessee Titans",
			//	Action = "Rank Add Player, Merge TruePlayerId",
			//	UserFullName = "Steve Miller",
			//	DraftsRanksText = "2015 Steve's Kitchen League Ranks",
			//	AddTimestamp = DateTime.Now
			//});
			//model.AddedPlayers.Add(new Models.Types.AdjustedPlayer
			//{
			//	PlayerId = 1154,
			//	TruePlayerId = 75,
			//	PlayerName = "Colin Kaepernick",
			//	Position = "QB",
			//	NFLTeamDisplay = "Denver Broncos",
			//	Action = "Add Player, Match Active, IsDrafted (& Ranks)",
			//	UserFullName = "---",
			//	DraftsRanksText = "2015 Kitchen League (and more...)",
			//	AddTimestamp = DateTime.Now
			//});

			//model.OtherAdjPlayers = new List<Models.Types.AdjustedPlayer>();
			//model.OtherAdjPlayers.Add(new Models.Types.AdjustedPlayer
			//{
			//	PlayerId = 1893,
			//	TruePlayerId = 1893,
			//	PlayerName = "Quiznatodd Bidness",
			//	Position = "TE",
			//	NFLTeamDisplay = "Miami Dolphins",
			//	Action = "Draft Update NFL Team, Activate",
			//	UserFullName = "Dave Nickelsen",
			//	DraftsRanksText = "2015 Fridge Football (and more...)",
			//	AddTimestamp = DateTime.Now
			//});
			//model.OtherAdjPlayers.Add(new Models.Types.AdjustedPlayer
			//{
			//	PlayerId = 655,
			//	TruePlayerId = 655,
			//	PlayerName = "Hingle McCringleberry",
			//	Position = "WR",
			//	NFLTeamDisplay = "Tampa Bay Buccaneers",
			//	Action = "Draft Activate Player",
			//	UserFullName = "Jeremiah Yugulis",
			//	DraftsRanksText = "2015 Dodge Dynasty",
			//	AddTimestamp = DateTime.Now
			//});
			//model.OtherAdjPlayers.Add(new Models.Types.AdjustedPlayer
			//{
			...
			//	PlayerName = "Colin Kaepernick",
			//	Position = "QB",
			//	NFLTeamDisplay = "San Francisco 49ers",
			//	Action = "Deactivate Drafted Player - New Team (2)",
			//	UserFullName = "---",
			//	DraftsRanksText = "---",
			//	AddTimestamp = DateTime.Now
			//});
